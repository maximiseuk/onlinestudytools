...
export default () => {
    ...
    return (
        <div className={classes.topBar}>
            <img src="/images/dots.png" alt="" className={classes.img} />
            <div className={classes.messageContainer}>
                <Typography variant="h2" gutterBottom>
                    {pageTitle === "Home" ? (
                        <span>
                            Good {message}, <span className={classes.highlight}>Pratyaksh</span>
                        </span>
                    ) : (
                        pageTitle
                    )}
                ...
                {pageTitle === "Home" && (
                    <Typography variant="h4">{date.toLocaleDateString() + " " + date.toLocaleTimeString().substring(0, 4)}</Typography>
                )}
            </div>
