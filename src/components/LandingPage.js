...
const useStyles = makeStyles(theme => ({
    ...
    pageFour: {
        ...
        width: "100vw",
        height: "110vh",
        backgroundImage: 'linear-gradient(to bottom, rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.2)), url("images/server.jpg")',
        backgroundSize: "cover",
        boxShadow: "0 -2px 10px #000000"
    },
    pageFourText: {
                ...
                <div style={{ position: "relative", height: "100vh", overflow: "hidden" }}>
                    ...
                    <div className={classes.textContainer}>
                        <div>
                            ...
                            />
                            <Button component="a" href="https://www.ebay.co.uk/itm/362941675984" variant="contained" className={classes.btn}>
                                Buy now
                            </Button>
                ...
                <div className={classes.rest}>
                    ...
                    <div className={classes.pageOne}>
                        <div className={classes.pageOneText}>
                            ...
                            <Typography className={classes.description}>
                                The PASSBox contains stationery, revision tip cards, sticky notes and blank flashcards to equip you with the tools
                                that helped us with our revision.
                                <br />
                                <br />
                                According to the{" "}
                                ...
                                , fragrance can have a positive effect on your mood and productivity. The PASSbox includes aromatic pouches of
                    ...
                    <div className={classes.pageTwo}>
                        <div className={classes.pageTwoContainer}>
                            ...
                            <img src="/images/iphonetimetable.png" alt="" className={classes.iphone} />
                            <div className={classes.pageTwoText}>
                                <Typography className={classes.slogan}>
                                    <span className="highlight">Structure</span> your path to success with your online{" "}
                                ...
                                <Button
                                    component="a"
                                    href="https://www.ebay.co.uk/itm/362941675984"
                                    variant="contained"
                    ...
                    <div className={classes.pageFour}>
                        <div className={classes.pageFourText}>
                            ...
                            <Typography className={classes.description}>
                                Using advanced machine learning models dedicated to improving grades, the timetable adapts to account for your
                                strengths and weaknesses in different subjects, so you're always making the most of your time.
                                <br />
                                <br />
                                The website also includes advice from succesful students, daily agendas and long-term goals. The effects of
                                target-setting are "robust, typically yielding a success rate of 90%" according to studies such as{" "}
                                <a
                    ...
                    <div className={classes.pageThree}>
                        ...
                        <div>
                            <div className={classes.personRow}>
                                <div className={classes.person}>
                                    <img src="images/oscar.jpeg" alt="" className={classes.personPic} />
                                ...
                                <div className={classes.person}>
                                    <img src="images/shannon.jpeg" alt="" className={classes.personPic} />
                                    <Typography className={classes.personText}>
                                        Shannon
                                        <br />
                                ...
                                <div className={classes.person}>
                                    <img src="images/hardik.jpeg" alt="" className={classes.personPic} />
                                    <Typography className={classes.personText}>
                                        Hardik
                                        <br />
                                        Marketing Director
                                ...
                                <div className={classes.person}>
                                    <img src="images/joecob.jpeg" alt="" className={classes.personPic} />
                                    <Typography className={classes.personText}>
                                        Joseph and Jacob
                                        <br />
                                ...
                                <div className={classes.person}>
                                    <img src="images/tom.jpeg" alt="" className={classes.personPic} />
                                    <Typography className={classes.personText}>
                                        Tom
                                        <br />
                                        Finance Director
                            ...
                            <div className={classes.personRow}>
                                <div className={classes.person}>
                                    <img src="images/prat.jpeg" alt="" className={classes.personPic} />
                                    <Typography className={classes.personText}>
                                        Pratyaksh
                                        <br />
                                ...
                                <div className={classes.person}>
                                    <img src="images/raymond.jpeg" alt="" className={classes.personPic} />
                                    <Typography className={classes.personText}>
                                        Raymond
                                        <br />
                                        Sales Director
                                ...
                                <div className={classes.person}>
                                    <img src="images/toby.jpeg" alt="" className={classes.personPic} />
                                    <Typography className={classes.personText}>
                                        Toby
                                        <br />
                                ...
                                <div className={classes.person}>
                                    <img src="images/ryan.jpeg" alt="" className={classes.personPic} />
                                    <Typography className={classes.personText}>
                                        Ryan
                                        <br />
                                ...
                                <div className={classes.person}>
                                    <img src="images/libi.jpeg" alt="" className={classes.personPic} />
                                    <Typography className={classes.personText}>
                                        Libi
                                        <br />
                                        Company Secretary
                        ...
                        <div className={classes.footer} id="footer">
                            ...
                            <Typography>
                                We are happy to help you with any problems or questions you may have - just email us at{" "}
                                <a href="mailto:contact.maximise@gmail.com" className="highlight">
                                    contact.maximise@gmail.com
                                </a>
                            </Typography>
                            <a href="https://www.facebook.com/maximise.ye/">
                                <Icon className="fab fa-facebook" style={{ color: "#ffffff", padding: "0.5vw" }} />
                            </a>
                            <a href="https://www.instagram.com/maximiseuk/">
                                <Icon className="fab fa-instagram" style={{ color: "#ffffff", padding: "0.5vw" }} />
                            </a>
                            <a href="https://www.tiktok.com/@maximiseuk">
                                <Icon className="fab fa-tiktok" style={{ color: "#ffffff", padding: "0.5vw" }} />
                            </a>
                            <Typography style={{ color: "#aaaaaa" }}>
                                Young Enterprise in England and Wales (including the Channel Islands) A Company Limited by Guarantee No. 712260
                                Charity No. 313697 Registered office: Young Enterprise, Yeoman House, Sekforde Street, London EC1R 0HF
                            </Typography>
                        </div>
                    </div>
                </div>
